...
\title{A Study of Transcription and Its Affects}
...
\begin{abstract}
  Research project investigating hits calculated from PSSMs and there correlations to each other. [State a property of the thing you’re investigating]. [State why this property gives you ample opportunity to model and investigate behavior]. The project team hypothesized that [what you tried to show]. This team [was able] / [wasn’t able]  to [achieve hypothesis] with [conclusion] and [error]
